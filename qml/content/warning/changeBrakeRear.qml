...
Item {
    ...
    states: [
        State {
            name: ""
            PropertyChanges { target: changeBrakeRear; opacity: 0.0 }
        },
        State {
            name: "show"
            PropertyChanges { target: changeBrakeRear; opacity: 1.0 }
    ...
    transitions: [
        Transition {
            ...
            to: "show"
            SequentialAnimation {
                NumberAnimation{ target: changeBrakeRear; property: "opacity"; duration: 500 }
            }
        }
    ]
