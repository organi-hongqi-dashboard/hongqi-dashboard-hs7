...
Rectangle {
    ...
    property bool espLightValue: CarStatus.espLight
...
//    }
//    Image {
//        id: refillCleanFluidLight
//        x: 1228
//        y: 15
//        opacity: 1.0
//        width: 38
//        height: 43
//        source: "qrc:/carTipsIcon/images/carTipsIcon/refillCleanFluidLight.png"
//    }
//    Image {
...
//    }
    Image {
        ...
        x: 1060
        y: 19
        opacity: afsOffLightValue ? 1.0 : 0.0
        width: 49
        height: 42
...
//    }
    ...
    Image {
        ...
        x: 696
        y: 22
        opacity: rearFogLightValue ? 1.0 : 0.0
        width: 51
        height: 39
    ...
    Image {
        ...
        x: 758
        y: 23
        opacity: frontFogLightValue ? 1.0 : 0.0
        width: 48
        height: 38
    ...
    Image {
        ...
        x: 814
        y: 27
        opacity: positionLightValue ? 1.0 : 0.0
        width: 55
        height: 30
